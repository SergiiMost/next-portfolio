...
export default function SoFilter({ likes }) {
  ...
  return (
    <>
      <Head>
        <title>Sergii Mostovyi - stackoverflow filter project.</title>
      ...
      <header ref={top}>
        <Wrapper>
          <Navbar />
          <Heading tag='h1'>stackoverflow filter.</Heading>
        </Wrapper>
      </header>
        ...
        <Wrapper>
          <section>
            ...
            <div className={styles.description}>
              ...
              <p>
                I’m a huge fan of SO. I’ve noticed that by reading good questions and answers, I could learn a lot. SO
                is an amazingly well-engineered project, however, I was missing an ability to filter out good questions
                within a selected time frame. Let me explain in greater detail.
              </p>
              <p className='u-mb-2'>
              ...
              <p className='u-mb-2'>
                It was not only a good opportunity to practically use <b>React Hooks</b> and <b>Context API</b> but also
                to improve my <b>UI/UX skills</b>. It was a very fun project to work on, and I use this small web app
                quite often.
              </p>
